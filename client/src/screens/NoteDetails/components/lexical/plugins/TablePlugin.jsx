...
import { $createNodeSelection, $createParagraphNode, $getSelection, $isRangeSelection, $isRootOrShadowRoot, $setSelection, COMMAND_PRIORITY_EDITOR, createCommand, } from 'lexical';
...
export function TablePlugin({ cellEditorConfig, children, }) {
    ...
    useEffect(() => {
        ...
        return editor.registerCommand(INSERT_TABLE_COMMAND, ({ columns, rows, includeHeaders }) => {
