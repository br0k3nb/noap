...
import { $createParagraphNode, $getNodeByKey, $getPreviousSelection, $getSelection, $isElementNode, $isRangeSelection, $setSelection, COMMAND_PRIORITY_EDITOR, COMMAND_PRIORITY_LOW, createCommand, DELETE_CHARACTER_COMMAND, INSERT_PARAGRAPH_COMMAND, KEY_ARROW_DOWN_COMMAND, } from 'lexical';
...
export default function CollapsiblePlugin() {
    ...
    useEffect(() => {
        ...
        editor.registerCommand(INSERT_PARAGRAPH_COMMAND, () => {
            ...
            return true;
        }, COMMAND_PRIORITY_EDITOR), editor.registerCommand(TOGGLE_COLLAPSIBLE_COMMAND, (key) => {
            editor.update(() => {
