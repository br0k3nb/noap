...
export default function ColorPicker({ color, children, onChange, disabled = false, ...rest }) {
    ...
    <DropDown {...rest} disabled={disabled} stopCloseOnClickSelf={true}>
      <div className="color-picker-wrapper" style={{ width: WIDTH }} ref={innerDivRef}>
        ...
        <div className="color-picker-basic-color">
          {basicColors.map((basicColor) => (<button className={basicColor === selfColor.hex ? ' active' : ''} key={basicColor} style={{ backgroundColor: basicColor }} onClick={() => {
        ...
        <MoveWrapper className="color-picker-saturation" style={{ backgroundColor: `hsl(${selfColor.hsv.h}, 100%, 50%)` }} onChange={onMoveSaturation}>
          <div className="color-picker-saturation_cursor" style={{
        ...
        <MoveWrapper className="color-picker-hue" onChange={onMoveHue}>
          <div className="color-picker-hue_cursor" style={{
