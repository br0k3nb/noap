      ...
      return (
        ...
        >
          <div className={`flex flex-row justify-center py-[4px] xxs:px-8 xl:px-0`}>
            ...
            <svg aria-hidden="true" role="status" className="hidden xl:inline w-4 h-4 ml-3 text-white animate-spin xxs:my-1 my-[1.5px]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
