  ...
  const renderer = ({ minutes, seconds, completed }: any) => {
    if (!completed) {
      return (
        ...
        >
          <div className={`flex flex-row justify-center py-[4px]`}>
            <span className='pt-0 xxs:pt-[2.4px]'>
              <p className='!text-xs'>
                  you can send another email in {minutes} minute(s) : {seconds} second(s)
              </p>  
            </span>
            <svg aria-hidden="true" role="status" className="inline w-4 h-4 ml-3 text-white animate-spin xxs:my-1 my-[1.5px]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <>
                        ...
                        {timer !== 'maximum' && timer !== '' ? (
                          ...
                          <>
                            ...
                            <button 
                              className='rounded-full py-2 text-sm uppercase tracking-widest transition-all duration-500 ease-in-out disabled:bg-gray-600 hover:cursor-not-allowed opacity-60'
                              disabled={true}
                              type='button'
                            >
                              <div className={`${!loader && 'hidden'} flex flex-row justify-center py-[1px]`}>
